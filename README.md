--[[
Age of Heroes - Premium UI (COMPLETO E CORRIGIDO)
Versão: 2.0.0
- Fast Punch funcional
- Player Teleport
- Loop TP
- Set Spawnpoint
]]
...
loopTitle.Size = UDim2.new(1, 0, 0, 25)
...
loopTargetLabel.Size = UDim2.new(1, -10, 0, 20)
loopTargetLabel.Position = UDim2.new(0, 5, 0, 35)
...
loopTargetLabel.TextSize = 12
loopTargetLabel.TextXAlignment = Enum.TextXAlignment.Center
loopTargetLabel.Parent = loopFrame

local loopToggle = Instance.new("TextButton")
loopToggle.Size = UDim2.new(0.6, 0, 0, 30)
loopToggle.Position = UDim2.new(0.2, 0, 0, 65)
